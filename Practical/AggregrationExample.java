...
class AggregrationExample{ //main class 
	...
	Student s = new Student(1,"sana","sana@gmail.com",98745435,i);
	Student s1 = new Student(2,"saima","saima@gmail.com",876544,i1);
	Student s2 = new Student(3,"sara","sara@gmail.com",981412,i2);
